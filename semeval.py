...
class SEMLoad(object):
    ...
    def parse_sen(self, path):
        ...
        for line in open(path, 'r'):
            ...
            sens = list(map(lambda x: self.word2id.get(x, self.word2id['<PAD>']), sens))    #将句子用数字表示
    ...
    def get_lexical_feature(self, sens):
        ...
        : # WordNet hypernyms (This is not included!!!)
        '''
    ...
    def get_sentence_feature(self, sens):
        ...
        for sen in sens:
            ...
            for idx in range(ori_len):
                ...
                # The origin operation seems disallowing the negative numbers.
                # p1 = idx - pos_e1[0]
                # p2 = idx - pos_e2[1]
        ...
        #     distance1, distance2 = []
        #     ori_len = len(sen)
        #     for index in range(ori_len):
        #         d1 = index - pos_e1
        #         d2 = index - pos_e2
        #         distance1.append(d1)
        #         distance2.append(d2)
        #         p1 = self.word2id(sen[index - 1])
        #         p2 = self.word2id(sen[index + 1])
        #         pos_left.append(p1)
        #         pos_right.append(p2)
        #         if (index==0):  p1 = 0  #xs
        #         if (index == ori_len - 1):  p2 = 0  #xe
        #         update_sens.append(p1, sen, p2, d1, d2)
